    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <span
          ...
          className="pointer-events-none shrink-0 group-aria-expanded/accordion-trigger:hidden flex items-center"
        >
          <CaretDownIcon size={16} />
        </span>
        <span
          data-slot="accordion-trigger-icon"
          className="pointer-events-none hidden shrink-0 group-aria-expanded/accordion-trigger:inline flex items-center"
        >
          <CaretUpIcon size={16} />
        </span>
      </AccordionPrimitive.Trigger>
