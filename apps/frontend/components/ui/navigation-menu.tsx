...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <span className="relative top-px ml-1 size-3 flex items-center justify-center transition duration-300 group-data-popup-open/navigation-menu-trigger:rotate-180 group-data-open/navigation-menu-trigger:rotate-180">
